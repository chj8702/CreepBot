...
CreepBot is a Slack bot that is designed to do polling and point tracking for
...
CreepBot utilizes Slack's Event API to listen for and forward events. It's pretty nice because it means that the bot doesn't have to listen to everthing, instead Slack will :)
